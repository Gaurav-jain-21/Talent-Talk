...
<div class="sidebar">
    ...
    <div class="menu">
        <a href="companyDashboard.jsp" class="active"><i class="fa fa-home"></i> Dashboard</a>
        <a href="companyClient.jsp"><i class="fa fa-users"></i> Client</a>
        <a href="companyJobs.jsp"><i class="fa fa-briefcase"></i> Post Jobs</a>
