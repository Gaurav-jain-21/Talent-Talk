...
<div class="sidebar">
    ...
    <div class="menu">
        ...
        <a href="#"><i class="fa-solid fa-file-invoice"></i> Invoice</a>
        <a href="#"><i class="fa-solid fa-chart-pie"></i> Insights</a>
        <a href="adminPayment.jsp" class="active"><i class="fa-solid fa-credit-card"></i> Payments</a>
